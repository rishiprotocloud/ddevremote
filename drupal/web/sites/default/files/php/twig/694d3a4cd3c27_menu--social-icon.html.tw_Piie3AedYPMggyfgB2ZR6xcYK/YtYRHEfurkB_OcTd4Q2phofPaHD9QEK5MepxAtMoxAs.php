...
class __TwigTemplate_bc11c95210c751654cf5e9df27582ef2 extends Template
{
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      <li{{ item.attributes }}>
        {% set icon_attr = create_attribute() %}
        <a href=\"{{ item.url }}\">
          <i {{ icon_attr.addClass(classes) }}></i>
          {{ item.title }}
        </a>
...
", "themes/villaagency/templates/menu/menu--social-icon.html.twig", "/var/www/html/web/themes/villaagency/templates/menu/menu--social-icon.html.twig");
    }
